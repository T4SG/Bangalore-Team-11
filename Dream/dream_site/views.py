  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="" method="POST">
            ...
            <div class="form-group">
              <button class="btn btn-primary btn-lg btn-block" onclick="document.location.href='MenteeMainPage.html'">Log In</button>
      ...
      <div class="modal-footer">
          <div class="col-md-12">
          <button class="btn" data-dismiss="modal" aria-hidden="true" onclick="document.location.href='index.html'">Cancel</button>
		  </div>	
      </div>
  </div>
  </div>
